...
class student:
    ...
    def __init__(self,win):        
        ...
        self.nombre = tk.Entry(win,state=self.state) #Nombres
        ...
        self.facultad = tk.Entry(win,bg="#cdcdcd")
        self.facultad.grid(row=2,column=3,sticky="W") #Facultad

        self.ciclo = tk.Spinbox(from_=1,to=10,width=5)
        self.ciclo.grid(row=3,column=3,sticky="W")
        
        self.fec_nac = DateEntry(win,background='darkblue', foreground='white', borderwidth=2,date_pattern="dd/MM/yyyy")
        ...
        ttk.Button(win,text="Editar").grid(row=3,column=4,sticky=tk.W+tk.E)
        ttk.Button(win,text="Eliminar",command=self.delete_student).grid(row=4,column=4,sticky=tk.W+tk.E)

    def unlocking_boxes(self):
        self.nombre = tk.Entry(win,state="normal")

    # def combo_box_facultad(self):
    #     self.response = self.cboCarrera.current()
    #     if self.response == "Ing.Sistemas":
    #         self.facultad.insert(0,"Ingeniería")
        # elif self.cboCarrera.current(4):
        #     self.facultad.insert(0,"Arquitectura")
        # elif self.cboCarrera.current(5):
        #     self.facultad.insert(0,"Comunicaciones")
        # else:
        #     self.facultad.insert(0,"")
    ...
    # def update_student(self,cod,dni):
